...
class BasicGenerator(keras.callbacks.Callback):
    def __init__(self, dataset_path, minibatch_size, img_c, img_w, img_h, frames_n, absolute_max_string_len=30, **kwargs):
        ...
        # Will be updated on next_train()get_output_size
    ...
    def build_dataset(self):
        if os.path.isfile(self.get_cache_path()): #cache file 
            ...
            # print str(self.train_list) + str(" : train_list")
            # print str(self.val_list) + str(" : val_list")
            # print str(self.align_hash) + str(" : align_hash")
